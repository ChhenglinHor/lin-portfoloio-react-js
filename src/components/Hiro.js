			...
			>
				...
				>
					<div className="flex flex-col w-full mt-8">
						...
						<h1 className="text-2xl font-bold">Chhenglin Hor</h1>
						<p class="text-xl font-bold text-gray-300">Frontend Engineer</p>
						<p className="text-md font-light text-gray-400 ">
							Logical and results-driven Frontend Developer dedicated to
					...
					<ul className="flex mt-2 gap-4 items-center">
						<li>
							<a
								href="https://github.com/ChhenglinHor"
								rel="noreferrer"
								target="_blank"
							>
						...
						<li>
							<a
								href="https://www.linkedin.com/in/chhenglin-hor-79054a173/"
								rel="noreferrer"
								target="_blank"
							>
